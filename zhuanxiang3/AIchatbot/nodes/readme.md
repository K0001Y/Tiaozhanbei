...
### 2.2 安全检查节点 - 输入阶段 (2_safety_guard_node.py)
...
### 2.3 RAG检索节点 (3_rag_retrieval_node.py)
...
### 2.4 意图识别节点 (4_recognize_intent_node.py)
...
### 2.5 症状提取节点 (5.1.1_symptom_extraction_node.py)
...
### 2.6 追问节点 (5.1.2_follow_up_question_node)
...
### 2.7 辨证分析节点 (5.1.3_diagnosis_node)
...
### 2.8 处方推荐节点 (5.1.4_prescription_node)
...
### 2.9 对话链处理节点 (5.2_conversation_chain_node)
...
### 2.10 响应安全检查节点 (6_response_safety_node)
